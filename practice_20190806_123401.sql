...
INSERT INTO `a` VALUES (1,'共和党',50),(2,'明进档',123),(3,'光明党',231),(66,'xxxx',22);
...
CREATE TABLE `sc` (
  ...
  KEY `idx_s` (`s`),
  KEY `idx_c` (`c`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='成绩表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sc` VALUES (1,1,1,80),(2,1,2,59),(3,2,1,67),(4,2,2,99),(5,1,3,59),(6,1,4,40),(7,2,3,45),(8,2,4,58);
...
-- Dump completed on 2019-08-06 12:34:01
